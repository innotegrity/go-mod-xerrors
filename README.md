...
<p align="center">
  ...
  <br />
  <a href="https://pkg.go.dev/mod.go.innotegrity.dev/xerrors" target="_blank"><img src="https://img.shields.io/badge/go-reference-2a7d98?style=for-the-badge" alt="Go Reference" /></a>
  <a href="https://goreportcard.com/report/mod.go.innotegrity.dev/xerrors" target="_blank"><img src="https://goreportcard.com/badge/mod.go.innotegrity.dev/xerrors?style=for-the-badge" alt="Go Report Card" /></a>
</p>
<br />
...
`mod.go.innotegrity.dev/xerrors` is an extended version of the built-in Golang `error` interface and includes an implementation of the interface.  This extended version includes an integer code attached to the error as well as any arbitrary attributes you wish to attach to the error along with the ability to capture caller information when the error is created.

Please review the [module documentation](https://pkg.go.dev/mod.go.innotegrity.dev/xerrors) for details on how to properly use the functions and types contained in this module.
